...
//    function validation(){
//     global $username,$gender,$phone,$email,$admin_position, $profile_photo;
...
//     if($username == NULL)
//     {
//         $error['username'] = 'Please Enter Your <b>Name</b>.';
//     }
//     else if(strlen($username)>30)
//     {
//         $error['username'] = '<b>Name Length</b> Cannot More Than <b>30 Characters</b>.';
//     }
//     else if(!preg_match('/^[A-Za-z @,\'\.\-\/]+$/',$username))
//     {
//         $error['username'] = 'Invalid <b>Name</b> Format. Can Contain Only Uppercase and Lowercase Alphabet, Space, Alias [ @ ],
...
//     {
//       $error['admin_position']='Please Enter the <b>Address.</b>';  
//     }
//     else if(!preg_match('/^[a-zA-Z0-9 @,\.\'\-\s\/]+$/',$admin_position))
//     {
//         $error['admin_position']  = 'Invalid <b>Address Format.</b> <br/>Can Contain Only Uppercase and Lowercase Alphabet, Space, Alias [ @ ],
//         Comma [ , ], Single-quote [ ‘ ], Dot [ . ], Dash [ - ] and Slash [ / ].';
//     }
...
function validation_ad(){
    ...
    {
        $error['admin_position']  = 'Invalid <b>Position Format.</b> <br/>Can Contain Only Uppercase and Lowercase Alphabet, Space, Alias [ @ ],
        Comma [ , ], Single-quote [ ‘ ], Dot [ . ], Dash [ - ] and Slash [ / ].';
    }
