             ...
             if($stmt->execute())
             {
                 ...
                 printf('
                     ...
                     Member <b>%s</b> has been Update.
                         ...
                         header("Location: userPorfile.php");
                         exit();
             }
             else{
...
<br/>
    <form action="" method="POST" enctype="multipart/form-data" style="float:right; border: 2px solid gray; box-shadow: 3px 3px 3px grey ;
        ...
        <tr>
        <td>Address &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
            <td><input class="search1" type="text" name="address" value="<?php echo isset($address)?$address:"" ?>" style="width: 550px;padding:5px; border-radius: 6px; border: none;"/></td>
        </tr>
    </table>
        <br/>
